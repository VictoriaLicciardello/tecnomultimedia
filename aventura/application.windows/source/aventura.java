/* autogenerated by Processing revision 1277 on 2021-12-12 */
...
public class aventura extends PApplet {
 ...
 */
 ...
 public void boton( String texto_, float x_, float y_, float diam_) {
 ...
 public boolean boton1(float x_, float y_, float xSup, float ySup, float radio)  {
...
/// RUTA NO 3 ///
 ...
 if( mousePressed ) { pantalla = 0; }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "aventura" };
    if (passedArgs != null) {
